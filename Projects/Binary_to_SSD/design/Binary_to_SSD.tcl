...
# File: Binary_to_SSD.tcl
# Generated on: Sun Dec 17 16:54:28 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "Binary_to_SSD"]} {
		puts "Project Binary_to_SSD is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists Binary_to_SSD]} {
		project_open -revision Binary_to_SSD Binary_to_SSD
	} else {
		project_new -revision Binary_to_SSD Binary_to_SSD
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "21:07:25  DECEMBER 13, 2023"
	...
	set_global_assignment -name VHDL_FILE Binary_to_SSD_tb.vhd
	set_location_assignment PIN_AD30 -to input[7]
	set_location_assignment PIN_AC28 -to input[6]
	set_location_assignment PIN_V25 -to input[5]
	set_location_assignment PIN_W25 -to input[4]
	set_location_assignment PIN_AC30 -to input[3]
	set_location_assignment PIN_AB28 -to input[2]
	set_location_assignment PIN_Y27 -to input[1]
	set_location_assignment PIN_AB30 -to input[0]
	set_location_assignment PIN_AA30 -to select_input
